...
s1_reference = s1*exp(1i*phref/57.3) + wgn(1,lengthCorr,NoiseDb,'complex');                    %%опорный сигнал
...
s1n_mix = s1*exp(1i*phSignal1/57.3) + SignalNoise*exp(1i*phSin/57.3)+ SignalNoise1*exp(1i*phSin1/57.3)+ wgn(1,lengthCorr,NoiseDb,'complex');     %%сумма сигнала1 и помех
s2n_mix = s1*exp(1i*phSignal2/57.3) + SignalNoise*exp(1i*phSin/57.3)+ SignalNoise1*exp(1i*phSin1/57.3)+ wgn(1,lengthCorr,NoiseDb,'complex');   %%сумма сигнала2 и помех
s_referense_interf = s1*exp(1i*phref/57.3) + SignalNoise + SignalNoise1 + wgn(1,lengthCorr,NoiseDb,'complex');%% сумма опорного сигнала и помех


mass_temp = 0:359;
%%воздействеи только белого шума
% for j1_ctr = 1:1:360     
